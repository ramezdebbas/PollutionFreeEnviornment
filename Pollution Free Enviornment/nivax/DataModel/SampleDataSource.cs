        ...
        public SampleDataSource()
        {
           // String ITEM_CONTENT = String.Format("");
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-1",
                    ...
                    group1) { CreatedOn = "Group", CreatedTxt = "Facts About Pollution", CreatedOnTwo = "Item", CreatedTxtTwo = "Health Risks", bgColour = "#6495ED", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/11.jpg")), CurrentStatus = "Pollution Free Environment" });
            group1.Items.Add(new SampleDataItem("Group-1-Item-2",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Facts About Pollution", CreatedOnTwo = "Item", CreatedTxtTwo = "Water Pollution", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/12.jpg")), CurrentStatus = "Pollution Free Environment" });
            group1.Items.Add(new SampleDataItem("Group-1-Item-3",
                    ...
                    group1) { CreatedOn = "Group", CreatedTxt = "Facts About Pollution", CreatedOnTwo = "Item", CreatedTxtTwo = "Land Pollution", bgColour = "#6495ED", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/13.jpg")), CurrentStatus = "Pollution Free Environment" });
            group1.Items.Add(new SampleDataItem("Group-1-Item-4",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Facts About Pollution", CreatedOnTwo = "Item", CreatedTxtTwo = "Better Pollution Awareness", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/14.jpg")), CurrentStatus = "Pollution Free Environment" });
            group1.Items.Add(new SampleDataItem("Group-1-Item-5",
                    ...
                    group1) { CreatedOn = "Group", CreatedTxt = "Facts About Pollution", CreatedOnTwo = "Item", CreatedTxtTwo = "Panelities and Incentives", bgColour = "#6495ED", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/15.jpg")), CurrentStatus = "Pollution Free Environment" });
            ...
            group2.Items.Add(new SampleDataItem("Group-2-Item-1",
                    ...
                    group2) { CreatedOn = "Group", CreatedTxt = "Ways on How to Prevent, Reduce", CreatedOnTwo = "Item", CreatedTxtTwo = "Environmental Protection", bgColour = "#6495ED", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/21.jpg")), CurrentStatus = "Pollution Free Environment" });
            group2.Items.Add(new SampleDataItem("Group-2-Item-2",
                     ...
                     group2) { CreatedOn = "Group", CreatedTxt = "How to Prevent", CreatedOnTwo = "Item", CreatedTxtTwo = "How can we help?", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/22.jpg")), CurrentStatus = "Pollution Free Environment" });
            group2.Items.Add(new SampleDataItem("Group-2-Item-3",
                      ...
                      group2) { CreatedOn = "Group", CreatedTxt = "How to Prevent", CreatedOnTwo = "Item", CreatedTxtTwo = "Final Thoughts", bgColour = "#20B2AA", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/23.jpg")), CurrentStatus = "Pollution Free Environment" });
            ...
            group3.Items.Add(new SampleDataItem("Group-3-Item-1",
                    ...
                    group3) { CreatedOn = "Group", CreatedTxt = "Help the Environment", CreatedOnTwo = "Item", CreatedTxtTwo = "Negative Effects of Globalization", bgColour = "#6495ED", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/31.jpg")), CurrentStatus = "Pollution Free Environment" });
            group3.Items.Add(new SampleDataItem("Group-3-Item-2",
                     ...
                     group3) { CreatedOn = "Group", CreatedTxt = "Help the Environment", CreatedOnTwo = "Item", CreatedTxtTwo = "How to live Green?", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/32.jpg")), CurrentStatus = "Pollution Free Environment" });
